"""
Django settings for rest_app_project project.
...
SECRET_KEY = ')elrlub#lewe)cbwip&=gdkqj11%9nktlaksx25fj+b803zo=4'
...
ROOT_URLCONF = 'rest_app_project.urls'
...
WSGI_APPLICATION = 'rest_app_project.wsgi.application'
